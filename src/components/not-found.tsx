  ...
  return (
    ...
    >
      ...
      <div className='absolute inset-0 -z-10 size-full'>
        <div className='absolute left-[47%] top-1/4 size-[24px] -translate-x-1/2 animate-pulse rounded-full bg-orange-400 blur-xl sm:size-[32px]' />
        <div className='absolute left-1/2 top-[15%] size-[48px] -translate-x-1/2 animate-pulse rounded-full bg-red-600 blur-xl sm:size-[64px]' />
        <div className='absolute left-[52%] top-[20%] size-[32px] -translate-x-1/2 animate-pulse rounded-full bg-yellow-500 blur-xl sm:size-[48px]' />
      </div>
    </m.div>
  );
}
